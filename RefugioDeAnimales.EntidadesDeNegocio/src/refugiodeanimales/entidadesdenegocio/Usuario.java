...
public class Usuario {
    ...
    public Usuario(int id, int idRol, String nombre, String apellido, String login, String password, String telefono, String direccion, int top_aux, String confirmPassword_aux, Rol rol) {
        this.id = id;
        this.idRol = idRol;
        this.nombre = nombre;
